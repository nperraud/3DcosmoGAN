...
import numpy as np
from cosmotools.data import fmap, load
...
class TestMetric(unittest.TestCase):
    ...
    def list_map_to_test(self):
        ...
        maps.append(('uint_forward', fmap.uint_forward, fmap.uint_backward))
        maps.append(('default', fmap.forward, fmap.backward))
        return maps

    def test_mapos(self):
        dataset = load.load_nbody_dataset(ncubes=1, spix=32, resolution=256,Mpch=350)
